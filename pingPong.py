...
def draw(canvas):
    global score1, score2, paddle1_pos, paddle2_pos, ball_pos, ball_vel,BALL_RADIUS,PAD_WIDTH,HALF_PAD_HEIGHT,acc
    ...
    ball_pos[0] += (ball_vel[0] * acc)
    ball_pos[1] += (ball_vel[1] * acc)
    ...
    # draw scores
    canvas.draw_text(str(score1), (200, 100), 80, "WHITE")
    canvas.draw_text(str(score2), (350, 100), 80, "WHITE")
